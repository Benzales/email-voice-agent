...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-lg dark:shadow-black/20 rounded-lg p-8 relative">
        <div className="absolute top-4 right-4">
          <ThemeToggle />
        </div>
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Privacy Policy</h1>
          <h2 className="text-xl text-gray-700 dark:text-gray-300 mb-6">Voice Email Agent</h2>
          
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 dark:border-blue-600">
          ...
          <section className="mb-8">
            ...
            <div className="mb-4">
              <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">OAuth Authentication Data:</h4>
            ...
            <div className="mb-6">
              <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">Voice Data:</h4>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <div className="mb-4">
              <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">Session Data:</h4>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <div className="mb-6">
              <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">Technical Data:</h4>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">2.3 Gmail Data Access</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-3">Through your explicit OAuth consent, we access:</p>
            ...
            <div className="p-4 bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 dark:border-yellow-600">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.1 Primary Service Functions</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.2 Service Improvement</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.3 Legal and Safety</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Data Processing and Storage</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.1 Voice Data Processing</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.2 Session and Authentication Data</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.3 Gmail Data Handling</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.1 Third-Party Services</h3>
            <div className="mb-4">
              <p className="text-gray-700 dark:text-gray-300 mb-3"><strong>Google Services:</strong></p>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 dark:border-blue-600">
                <p className="text-gray-700 dark:text-gray-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.2 We Do Not Sell Your Data</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              We do not sell, rent, or trade your personal information to third parties for marketing purposes.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.3 Legal Disclosures</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-3">We may disclose your information if required by law or to:</p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.1 Security Measures</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.2 Security Monitoring</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.3 Data Breach Response</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-3">In the event of a security incident, we will:</p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. Your Privacy Rights</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">7.1 Access and Control</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">7.2 OAuth Permissions</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">7.3 Communication Preferences</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">8.1 Retention Periods</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">8.2 Data Deletion</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">10. International Data Transfers</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">11. California Privacy Rights (CCPA)</h2>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              To exercise these rights, contact us at <a href="mailto:benjamingonzales121102@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">benjamingonzales121102@gmail.com</a>.
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">12. European Union Privacy Rights (GDPR)</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-3">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Contact us at <a href="mailto:benjamingonzales121102@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">benjamingonzales121102@gmail.com</a> to exercise these rights.
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">13. Changes to This Privacy Policy</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-3">
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Email:</strong> <a href="mailto:benjamingonzales121102@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">benjamingonzales121102@gmail.com</a><br />
                <strong>Website:</strong> <a href="https://courieragent.ai" className="text-blue-600 dark:text-blue-400 hover:underline">https://courieragent.ai</a><br />
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">15. Effective Date</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
